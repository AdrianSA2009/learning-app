...
var init_from = __esmMin((() => {
	...
	blobFromSync = (path, type) => fromBlob((0, node_fs.statSync)(path), path, type);
	...
	fileFromSync = (path, type) => fromFile((0, node_fs.statSync)(path), path, type);
...
Object.defineProperty(exports, "init_esm_min", {
	enumerable: true,
	get: function() {
		return init_esm_min;
	}
});
Object.defineProperty(exports, "init_fetch_blob", {
	enumerable: true,
	get: function() {
		return init_fetch_blob;
	}
});
Object.defineProperty(exports, "init_file", {
	enumerable: true,
	get: function() {
		return init_file;
	}
});
Object.defineProperty(exports, "init_from", {
	enumerable: true,
	get: function() {
		return init_from;
	}
