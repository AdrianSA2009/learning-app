const require_from = require("./from-BFj9iVa6.js");
...
async function toFormData(Body, ct) {
	...
	const appendFileToFormData = () => {
		const file = new require_from.File(entryChunks, filename, { type: contentType });
...
//#endregion
require_from.__esmMin((() => {
	require_from.init_from();
	require_from.init_esm_min();
	s = 0;
	S = {
		START_BOUNDARY: s++,
